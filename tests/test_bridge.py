...
def test_no_tool_bypasses_api_authorization(tmp_path):
    ...
    calls = {
        ...
        "get_ironsworn_sheet": {"profile_id": "tara"},
        "update_ironsworn_sheet": {"profile_id": "tara", "updates": {"momentum": 3}},
        "roll_ironsworn_dice": {"profile_id": "tara"},
        "delete_file": {"profile_id": "tara", "filename": "f.txt"},
        "search_memories": {"profile_id": "tara", "query": "x"},
        "search_context": {"profile_id": "tara", "query": "x"},
        "prepare_closeout": {"profile_id": "tara"},
        ...
        "add_records": {"profile_id": "tara", "store_name": "n1", "records": []},
            ...
            "grade_exam_questions": {"companion_name": "lt_rita", "attempt_code": "a1",
                                      "answers": [{"position": 1, "selected": ["A"]}]},
            "regrade_exam_questions": {"companion_name": "lt_rita", "attempt_code": "a1",
                                         "answers": [{"position": 1, "selected": ["A"]}],
